/*
   ...
   SDA to SDA,
   SCL to SCL
   and a positive power supply to a peripheral,
   usually 3.3V
  ...
  We need an Arduino library for this. Download the
...
//double baseline =1655.0; // baseline pressure
double baseline;
void setup()
{
  Serial.begin(9600);
...
void loop() {
  ...
  a = pressure.altitude(P1, baseline);
